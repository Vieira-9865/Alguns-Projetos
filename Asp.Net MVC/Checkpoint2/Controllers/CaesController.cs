    ...
    public class CaesController : Controller
    {
        ...
        public ActionResult Index(int? IdRacaFiltro)
        {
            ...
            if (IdRacaFiltro != null)
            {
                ...
                {
                    var bb = db.Dono1.Where(h => h.IdDono == item22.IdDono).FirstOrDefault();
            ...
            {
                var bb = db.Dono1.Where(h => h.IdDono == item.IdDono).FirstOrDefault();
        ...
        public ActionResult Create()
        {
            ...
            List<Donos> listaDonos = db.Dono1.ToList();
